...
{	
	...
	[Tooltip("Whether the avatar's position should match color image (Pos-Relative mode only).")]
	public bool posRelUseOverlay = false;
...
//		}
	...
	protected void MoveAvatar(Int64 UserID)
	{
		...
		if(posRelativeToCamera && posRelUseOverlay)
		{
